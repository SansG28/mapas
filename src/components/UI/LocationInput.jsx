...
/* Aca vamos a usar un debounce para mejorar el rendimiento. Esta
es una técnica de optimización en front para limitar la frecuencia con
la que se ejecuta una función.*/
